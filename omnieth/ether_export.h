 ...
 *      OETH_LINUX_PIF$ETHER_CONFIG_ARP_OFFLOAD command
 */
 ...
 *      OETH_LINUX_PIF$ETHER_CONFIG_PTP_OFFLOAD command
 */
struct ptp_offload_param {
	...
	/** indicates PTP mode
	 * - Valid values:
         *   - OETH_LINUX_PIF$ETHER_PTP_ORDINARY_MASTER
         *   - OETH_LINUX_PIF$ETHER_PTP_ORDINARY_SLAVE
         *   - OETH_LINUX_PIF$ETHER_PTP_TRASPARENT_MASTER
         *   - OETH_LINUX_PIF$ETHER_PTP_TRASPARENT_SLAVE
         *   - OETH_LINUX_PIF$ETHER_PTP_PEER_TO_PEER_TRANSPARENT */
	int mode;
	/** ptp domain
...
/**
 * @brief Structure for L2 filters OETH_LINUX_PIF$ETHER_L2_ADDR command
 */
struct ether_l2_filter {
	...
	/** dma channel number, values are:
         * - from 0 to OETHRM_PIF$OSI_EQOS_MAX_NUM_CHANS for EQOS
         * - from 0 to OETHRM_PIF$OSI_MGBE_MAX_NUM_CHANS for MGBE */
	u32 dma_chan;
};
...
struct ether_exported_ifr_data {
	...
	/** qinx: Queue index to be used for certain ioctls
         * - Valid range:
         *  - 0 to OETHRM_PIF$OSI_MGBE_MAX_NUM_QUEUES for MGBE
         *  - 0 to OETHRM_PIF$OSI_EQOS_MAX_NUM_QUEUES for EQOS */
	u32 qinx;
	/** The private ioctl command number
	 * - Valid range: should be defined in private IOCTL group
	 * - Expected values:
	 *    - OETH_LINUX_PIF$EQOS_GET_CONNECTED_SPEED
	 *    - OETH_LINUX_PIF$ETHER_AVB_ALGORITHM
	 *    - OETH_LINUX_PIF$EQOS_L3L4_FILTER_CMD
	 *    - OETH_LINUX_PIF$EQOS_VLAN_FILTERING_CMD
	 *    - OETH_LINUX_PIF$ETHER_CONFIG_ARP_OFFLOAD
	 *    - OETH_LINUX_PIF$ETHER_CONFIG_PTP_OFFLOAD
	 *    - OETH_LINUX_PIF$ETHER_GET_AVB_ALGORITHM
	 *    - OETH_LINUX_PIF$ETHER_PTP_RXQUEUE
	 *    - OETH_LINUX_PIF$ETHER_CONFIG_EST
	 *    - OETH_LINUX_PIF$ETHER_CONFIG_FPE
	 *    - OETH_LINUX_PIF$ETHER_CONFIG_FRP_CMD
	 *    - OETH_LINUX_PIF$ETHER_MC_DMA_ROUTE
	 *    - OETH_LINUX_PIF$ETHER_PAD_CALIBRATION
	 *    - OETH_LINUX_PIF$ETHER_CAP_TSC_PTP
	 *    - OETH_LINUX_PIF$ETHER_M2M_TSYNC
	 *    - OETH_LINUX_PIF$ETHER_L2_ADDR */
	u32 ifcmd;
...
enum ob_macsec_nl_commands {
	/** MACSEC netlink command for MACSEC HW initilization */
	OB_MACSEC_CMD_INIT,
	/** MACSEC netlink command to get next PN */
	OB_MACSEC_CMD_GET_TX_NEXT_PN,
	/** MACSEC netlink command to set replay protection */
	OB_MACSEC_CMD_SET_REPLAY_PROT,
	/** MACSEC netlink command to set Cipher */
	OB_MACSEC_CMD_SET_CIPHER,
	/** MACSEC netlink command to set protect frames */
	OB_MACSEC_CMD_SET_PROTECT_FRAMES,
	/** MACSEC netlink command to set encryption mode */
	OB_MACSEC_CMD_SET_ENCRYPT,
	/** MACSEC netlink command to create TX SA */
	OB_MACSEC_CMD_CREATE_TX_SA,
	/** MACSEC netlink command to enable TX SA */
	OB_MACSEC_CMD_EN_TX_SA,
	/** MACSEC netlink command to disable TX SA */
	OB_MACSEC_CMD_DIS_TX_SA,
	/** MACSEC netlink command to create RX SA */
	OB_MACSEC_CMD_CREATE_RX_SA,
	/** MACSEC netlink command to enable RX SA */
	OB_MACSEC_CMD_EN_RX_SA,
	/** MACSEC netlink command to disable RX SA */
	OB_MACSEC_CMD_DIS_RX_SA,
	/**MACSEC netlink command to TZ config */
	OB_MACSEC_CMD_TZ_CONFIG,
	/**MACSEC netlink command to TZ reset */
	OB_MACSEC_CMD_TZ_KT_RESET,
	/** MACSEC netlink command to de-initialize the MACSEC HW */
	OB_MACSEC_CMD_DEINIT,
	/** MACSEC PN event multicast notification (driver→userspace) */
	OB_MACSEC_CMD_PN_EVENT,
};

/** @brief MACsec PN event notification attributes (multicast) */
enum ob_macsec_pn_event_attrs {
	OB_MACSEC_PN_EVENT_ATTR_UNSPEC,
	/** interface name (NLA_STRING) */
	OB_MACSEC_PN_EVENT_ATTR_IFNAME,
	/** controller: 0=TX, 1=RX (NLA_U32) */
	OB_MACSEC_PN_EVENT_ATTR_CTLR,
	/** SA index (NLA_U32) */
	OB_MACSEC_PN_EVENT_ATTR_SA_IDX,
	/** SC index (NLA_U32) */
	OB_MACSEC_PN_EVENT_ATTR_SC_IDX,
	/** event type: 0=threshold, 1=exhausted (NLA_U32) */
	OB_MACSEC_PN_EVENT_ATTR_EVENT_TYPE,
	__OB_MACSEC_PN_EVENT_ATTR_END,
	NUM_OB_MACSEC_PN_EVENT_ATTR = __OB_MACSEC_PN_EVENT_ATTR_END - 1,
};
