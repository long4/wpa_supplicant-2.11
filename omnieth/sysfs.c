...
#ifdef ETHER_GRO
/**
 * @brief Shows the current setting of GRO packet age threshold.
 *
 * @param[in] dev: Device data.
 * @param[in] attr: Device attribute
 * @param[in] buf: Buffer to store the current ptp sync method
...
/**
 * @brief Set the user setting of GRO packet age threshold.
 *
 * @param[in] dev: Device data.
 * @param[in] attr: Device attribute
 * @param[in] buf: Buffer which contains the user settings of MAC loopback
...
/**
 * @brief Sysfs attribute for GRO packet age threshold
 *
 */
...
/**
 * @brief Shows the current setting of GRO purge timer interval..
 *
 * @param[in] dev: Device data.
 * @param[in] attr: Device attribute
 * @param[in] buf: Buffer to store the current ptp sync method
...
/**
 * @brief Set the user setting of GRO purge timer interval.
 *
 * @param[in] dev: Device data.
 * @param[in] attr: Device attribute
 * @param[in] buf: Buffer which contains the user settings of MAC loopback
...
/**
 * @brief Sysfs attribute for GRO purge timer interval
 *
 */
...
/**
 * @brief Sysfs attribute for GRO stats.
 *
 */
...
/**
 * @brief Sysfs attribute for GRO queue dump.
 *
 */
...
#if defined HSI_SUPPORT && defined(OMNI_TEST) && (IS_ENABLED(CONFIG_TEGRA_HSIERRRPTINJ))
...
/**
 * @brief Attributes for ob01 ethss sysfs
 */
...
/**
 * @brief Attributes for ob01 ethss sysfs without MACSEC
 */
...
static int ether_create_debugfs(struct ether_priv_data *pdata)
{
	...
	buf = kasprintf(GFP_KERNEL, "omnieth-%s", pdata->ndev->name);
	if (!buf)
		return -ENOMEM;
...
int ether_sysfs_register(struct ether_priv_data *pdata)
{
	...
	/* Create ob01 ethss sysfs group under /sys/devices/<ether_device>/ */
...
MODULE_AUTHOR("OMNI Corporation");
MODULE_DESCRIPTION("Mac/Macsec Sysfs driver");
MODULE_LICENSE("GPL");
#if defined(OB_MODULE_IMPORT_NS_CALLS_STRINGIFY)
