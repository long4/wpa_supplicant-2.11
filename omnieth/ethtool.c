...
#if defined(OB_ETHTOOL_KERNEL_ETHTOOL_TS_INFO_STRUCT_PRESENT) /* Linux v6.11 */
 ...
 */
#if defined(OB_ETHTOOL_OPS_GET_SET_COALESCE_HAS_COAL_AND_EXTACT_ARGS) /* Linux v5.15 */
...
#if defined(OB_ETHTOOL_KEEE_STRUCT_PRESENT) /* Linux v6.9 */
 ...
 * @retval 0 on success
 */
#if defined(OB_ETHTOOL_OPS_GET_SET_RXFH_HAS_RXFH_PARAM_ARGS)
...
#if defined(OB_ETHTOOL_OPS_GET_SET_RINGPARAM_HAS_RINGPARAM_AND_EXTACT_ARGS) /* Linux v5.17 */
