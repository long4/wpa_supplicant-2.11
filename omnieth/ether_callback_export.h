 ...
 * - "-ENOMEM" on  OETHRM_PIF#osi_get_core fail.
 * - "-ENOMEM" on  OETHRM_PIF#osi_get_dma fail.
 * - Return values of OETHRM_PIF#osi_handle_ioctl with
 *   the OETHRM_PIF$OSI_CMD_GET_HW_FEAT command.
 ...
 *
 * @pre Ethernet driver probe OETH_LINUX_PIF#ether_probe event
 ...
 * @return
 * - EOK on success
 * - "-EBUSY" on OETHRM_PIF#osi_handle_ioctl with OETHRM_PIF$OSI_CMD_SUSPEND fail.
 *
 * @dir
 * - forward
 *
 ...
 * @return
 * - EOK on success
 * - Return values of OETHRM_PIF#osi_handle_ioctl,
 *   with the OETHRM_PIF$OSI_CMD_RESUME command data.
 * - Return values of OETHRM_PIF#osi_handle_ioctl,
 *   with the OETHRM_PIF$OSI_CMD_PAD_CALIBRATION command data.
 *
 * @dir
 * - forward
 *
 ...
 * - EOK on success
 * - "-EINVAL" on invalid input data values.
 * - Return values of OETHRM_PIF#osi_hw_core_init value.
 * - Return values of OETHRM_PIF#osi_handle_ioctl,
 *   with the OETHRM_PIF$OSI_CMD_L2_FILTER command data.
 * - Return values of OETHRM_PIF#osi_hw_core_init.
 * - Return values of OETHRM_PIF#osi_hw_dma_init.
 * - Return values of OETHRM_PIF#osi_handle_ioctl,
 *   with the OETHRM_PIF$OSI_CMD_FREE_TS command data.
 * - Return values of OETHRM_PIF#osi_handle_ioctl,
 *   with the OETHRM_PIF$OSI_CMD_PAD_CALIBRATION command data.
 *
 * @dir
 ...
 *   execution of the OETH_LINUX_PIF#ether_open event.
 *
 * @return
 * - EOK on success
 *
 ...
 * - Return values of OETHRM_PIF#osi_read_phy_reg for SIOCGMIIREG cmd value.
 * - Return values of OETHRM_PIF#osi_read_phy_reg for SIOCSMIIREG cmd value.
 *
 * @dir
 * - forward
 *
 ...
 *  - Used Structure variables:
 *     - For all supported private IOCTLs Refer OETH_LINUX_PIF$ether_exported_ifr_data
 ...
 *     - OETH_LINUX_PIF$ETHER_PRV_RMDIO_IOCTL
 *     - OETH_LINUX_PIF$ETHER_PRV_WMDIO_IOCTL
 *
 * @usage
 * - Allowed context for the API call
 *    - Interrupt: No
 ...
 * - EOK on success
 * - "-EINVAL" on invalid input data values.
 * - "-EINVAL" if called before OETH_LINUX_PIF#ether_open event success.
 * - "-EOPNOTSUPP" on unsupported valued in cmd or rd
 * - "-EFAULT" on user IOCTL data copy
 * - "-EPERM" on user non admin user call
 * - Return values of OETHRM_PIF#osi_handle_ioctl for the cmd value SIOCDEVPRIVATE,
 *   with the OETH_LINUX_PIF$ether_exported_ifr_data.ifcmd in the "rd" input parameter.
 * - Return values of OETHRM_PIF#osi_read_phy_reg for the cmd value ETHER_PRV_RMDIO_IOCTL.
 * - Return values of OETHRM_PIF#osi_write_phy_reg for the cmd value ETHER_PRV_WMDIO_IOCTL.
 *
 * @dir
 * - forward
 *
 ...
 * - Return values of OETHRM_PIF#osi_handle_ioctl with
 *   the OETHRM_PIF$OSI_CMD_SET_AVB command.
 *
 * @dir
 * - forward
 *
 ...
 *      - De-initialization: No
 *
 * @pre Ethernet interface need to be down with OETH_LINUX_PIF#ether_close event
 *
 * @return
 * - EOK on success
 * - "-EINVAL" If the new_mtu is more than OETHRM_PIF$OSI_MTU_SIZE_9000
 * - Return values of OETHRM_PIF#osi_handle_ioctl with
 *   the OETHRM_PIF$OSI_CMD_MAC_MTU command.
 *
 * @dir
 * - forward
 *
 ...
 * - Return values of OETHRM_PIF#osi_handle_ioctl with
 *   the OETHRM_PIF$OSI_CMD_RXCSUM_OFFLOAD command.
 *
 * @dir
 * - forward
 *
 ...
 * @brief
 * Description:
 * - Work Queue function to call OETHRM_PIF#osi_handle_ioctl with
 *   OETHRM_PIF$OSI_CMD_READ_MMC IOCTL command periodically.
 *
 * @param[in] work:
 *  - work structure
 ...
 * @note
 * Algorithm:
 * - Calls OETHRM_PIF#osi_handle_ioctl with
 *   OETHRM_PIF$OSI_CMD_READ_MMC IOCTL command data
 ...
 *
 * @return
 * - EOK on OETHRM_PIF$OSI_CMD_ADJ_FREQ IOCTL success
 * - Return values of OETHRM_PIF#osi_handle_ioctl with
 *   the OETHRM_PIF$OSI_CMD_ADJ_FREQ IOCTL command.
 *
 * @dir
 * - forward
 *
 ...
 *
 * @return
 * - EOK on OETHRM_PIF$OSI_CMD_ADJ_TIME IOCTL success
 * - Return values of OETHRM_PIF#osi_handle_ioctl with
 *   the OETHRM_PIF$OSI_CMD_ADJ_TIME IOCTL command.
 *
 * @dir
 * - forward
 *
 ...
 * - Return values of OETHCL_PIF#osi_dma_get_systime_from_mac.
 *
 * @dir
 * - forward
 *
 ...
 *
 * @return
 * - EOK on OETHRM_PIF$OSI_CMD_SET_SYSTOHW_TIME IOCTL success
 * - Return values of OETHRM_PIF#osi_handle_ioctl with
 *   the OETHRM_PIF$OSI_CMD_SET_SYSTOHW_TIME command.
 *
 * @dir
 * - forward
 *
 ...
 *   OETHRM_PIF$osd_core_ops.restart_lane_bringup to restart the lane bringup process.
 *
 * @param[in] *priv:
 ...
 * Description:
 * - Implementing the callback for
 *   OETHRM_PIF$osd_core_ops.padctrl_mii_rx_pins to restart the PAD calibration process.
 *
 * @param[in] priv:
 *  - Pointer to private data structure.
 * @param[in] enable:
 ...
 * Description:
 * - Implementing the callback for
 *   OETHRM_PIF$osd_core_ops.ivc_send to send IVC message.
 *
 * @param[in] priv:
 *  - Pointer to private data structure.
 * @param[in] ivc_buf:
 *  - Pointer to  OETHRM_PIF$ivc_msg_common data structure.
 * @param[in] len:
 *  - length of data
 *
 * @usage
 ...
 * @return
 * - EOK on success
 * - Data bandwidth on success for OETH_LINUX_PIF#ether_ioctl$ETHER_GET_AVB_PERF
 ...
 * Description:
 * - Implementing the callback for
 *   OETHCL_PIF$osd_dma_ops.transmit_complete to report TX done.
 *
 * @param[in] priv:
 ...
 * Description:
 * - Implementing the callback for
 *   OETHCL_PIF$osd_dma_ops.receive_packet to report DMA receive packet.
 *
 * @param[in] priv:
 *  - OSD private data structure.
 * @param[in] rx_ring:
 ...
 * @brief
 * Description:
 * - Implementing the callback for OETH_LINUX_PIF$NV_MACSEC_CMD_INIT netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_SET_REPLAY_PROT netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_SET_CIPHER netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_DEINIT netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_EN_TX_SA netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_CREATE_TX_SA netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_DIS_TX_SA netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_EN_RX_SA netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_CREATE_RX_SA netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_DIS_RX_SA netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
 ...
 * Description:
 * - Implementing the callback for
 *   OETH_LINUX_PIF$NV_MACSEC_CMD_GET_TX_NEXT_PN netlink command.
 *
 * @param[in] skb:
 *  - SKB data structure.
 *  - Used Structure variables: None
