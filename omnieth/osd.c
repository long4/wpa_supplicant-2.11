 ...
 *
 * @param[in] nvgro_q: GRO packet sequence queue.
 ...
 *
 * @param[in] mq: GRO packet out of order queue.
...
/**
 * @brief ether_gro - Perform GRO packet merging.
 *
 * @param[in] fq: GRO packets sequence queue.
 * @param[in] mq: GRO packet out of order queue.
 * @param[in] napi: Driver NAPI instance.
 */
...
/**
 * @brief ether_nvgro_purge_timer - GRO purge timer handler.
 *
...
/**
 * @brief ether_do_nvgro - Perform GRO processing.
 *
 * @param[in] pdata: Ethernet private data.
			  ...
			  struct osi_dma_priv_data *osi_dma)
{
	...
	osi_core->osd_ops.macsec_pn_event = macsec_pn_event_handler;
